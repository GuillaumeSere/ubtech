    ...
    return (
        <html lang="fr">
            <head>
                ...
                <meta property="og:title" content="UBTECH Robot 3D – Landing Page Three.js" />
                ...
                <meta name="twitter:description" content="Landing page immersive avec un robot 3D en temps réel." />
